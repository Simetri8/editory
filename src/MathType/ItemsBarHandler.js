...
class ra extends React.Component {
	...
	renderTableCreator() {
		if (this.state.showTableCreator) {/*var e=ReactDOM.findDOMNode(this);if(e){var t=DOMHelper.getElementRect(e);var n=t.left+40;var r=t.top+60;}*/
			var n = 40;
			var r = 160;
	...
	render() {
		...
		return this.component ? (e.padding = 3, "nothing" == this.component.key && (e.display = "none"),
			React.createElement("items-bar", {
				...
				? React.createElement("x-nothing", null) : React.createElement("items-bar", {
					class: t,
					style: e
				},
					this.renderNormalItems(), this.renderTableCreator(), React.createElement("round-close-icon", {
