...
// Not found 'var' for: import  from './ShapeLoader';
...
var PointDetector = new class {
    ...
    getSnapablePointsEntity(e, t) {
        if (EntityUtils.isShapeArrow(e)) {
            ...
            if (EntityUtils.isShapeComposite(e)) console.warn("TODO: " + "Shape Loader .getShapeManagement");/*return a .a .getShapeManagement(e).getSnapablePoints(e);*/
