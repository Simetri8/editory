...
/// xxx(1379) /*Symbol-page-section-level-1*/
...
class c extends CompositeBlock {
    ...
    renderComponent() {
        return React.createElement("span", {
            className: "page-print-item role-page-section-level-1"
        },
        ...
        "Section Level 1"), React.createElement("span", {
            className: "page-print-item-hover"
        },
        "Page Section Level 1"))
    }
}
var SymbolPageSectionLevel1 = new class extends CompositeSymbolBase {
    getViewComponent() {
        return c
    }
    getLatextName() {
        return "\\page-section-level-1"
    }
    getSymbol() {
...
export default SymbolPageSectionLevel1