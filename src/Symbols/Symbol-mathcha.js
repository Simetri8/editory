...
/*n.d(t, "MatchaText", function () {
    return c
}),*/
/*n.d(t, "MatchaTextSc", function () {
    return d
});*/
class c extends CompositeBlock {
    constructor() {
        super(...arguments);
        this.containerClassName = "mathcha-text"
    }
    renderComponent() {
        ...
        return React.createElement("mathcha-text", {
            key: "math-text"
        },
        React.createElement("span", null, "Math"), React.createElement(l, {
            fontSize: n
        }))
    }
}
class d extends CompositeSymbolBase {
    ...
    getSymbolInfo() {
        return this.fillSymbolInfo({
            ...
            renderSymbol: () => React.createElement("mathcha-text", null, "Math", React.createElement(l, {
                fontSize: 15
            }))
        })
    }
...
var SymbolMathcha = new d

export { c as MatchaText }

export { d as MatchaTextSc }

export default SymbolMathcha