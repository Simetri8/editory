...
/// xxx(1381) /*Symbol-page-section-level-3*/
...
class c extends CompositeBlock {
    ...
    renderComponent() {
        return React.createElement("span", {
            className: "page-print-item role-page-section-level-3"
        },
        ...
        "Section Level 3"), React.createElement("span", {
            className: "page-print-item-hover"
        },
        "Page Section Level 3"))
    }
}
var SymbolPageSectionLevel3 = new class extends CompositeSymbolBase {
    getViewComponent() {
        return c
    }
    getLatextName() {
        return "\\page-section-level-3"
    }
    getSymbol() {
...
export default SymbolPageSectionLevel3