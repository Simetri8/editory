...
/// xxx(1384) /*Symbol-math-mode-group*/
...
class g extends CompositeBlock {
    ...
    getClassName() {
        return this.props.data.collapsed ? classNames(super.getClassName(), "math-mode-group-collapsed", "role-math-mode-group") : classNames(super.getClassName(), "math-mode-group-expanded", "role-math-mode-group")
    }
...
var SymbolMathModeGroup = new class extends CompositeSymbolBase {
    getViewComponent() {
        return g
    }
    getLatextName() {
        return "\\math-mode-group"
    }
    getSymbol() {
        return "group"
    }
...
export default SymbolMathModeGroup