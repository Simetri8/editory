...
/// xxx(902) /*Symbol-LaTeX*/

/// n.r(t)
/*n.d(t, "LatexText", function () {
    return l
}),*/
/*n.d(t, "LatexTextSc", function () {
    return d
});*/
...
class l extends CompositeBlock {
    constructor() {
        super(...arguments);
        this.containerClassName = "latex-text"
    }
    renderComponent() {
        ...
        return React.createElement("span", null, c(n))
    }
}
function c(e) {
...
class d extends CompositeSymbolBase {
    ...
    getSymbolInfo() {
        return this.fillSymbolInfo({
            ...
            renderSymbol: () => React.createElement("span", null, c(13)),
...
var SymbolLatex = new d

export { l as LatexText }

export { d as LatexTextSc }

export default SymbolLatex