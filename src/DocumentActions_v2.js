...
var SilentSaver = new class {
	constructor(appStorage, documentProvider) {
		this.appStorage = appStorage;
		this.documentInfo = documentProvider;
	}
	silentSave(e) {
...
var SaveWorker = new class {
	...
	handleAnonymousSave(e) {
		console.log("TODO handleAnonymousSave e", e.model, e)
		return this.appStorage.savePageContent(e.model).then((x) => {
			console.log("TODO handleAnonymousSave x", x)
		}).
			catch(() => {
				throw {
