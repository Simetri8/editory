...
import {
    Fab, Typography, Icon, IconButton
...
class DocumentInfo extends React.PureComponent {
    constructor() {
        ...
        this.handleMoreClick = () => {
            console.log("DocumentInfo.handleMoreClick")
            this.setState({
                showFullInfo: true
            });
        ...
        return <div>
            ...
            <Typography>
                ...
                <Typography variant="caption">
                    {e.language == "none" ? null : `Lang:${e.language}`}
                    {`Words: ${e.words}, Math: ${e.mathSections}`}
                </Typography>
            </Typography>
        </div>
        // return React.createElement("document-info-container", null,
        //     React.createElement("document-info-bar", {
        //         style: {
        //             cursor: "pointer"
        //         },
        //         onClick: this.handleMoreClick
        //     },
        //         React.createElement("span", null, "Lang:", e.language, ",Words:", e.words, ",Math:", e.mathSections, " ",
